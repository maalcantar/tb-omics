...
def calculate_neutral_masses(mzs):
    ...
    Currently returns lists of neutral masses
    """
    ...
    return plush, plusnh4, plush2o, plusna, plusk, plusch3cn
...
#        print('failed to parse hmdb')
    ...
    plush, plusnh4, plush2o, plusna, plusk, plusch3cn = calculate_neutral_masses(mzs)
